                ...
                <div className="bg-white border-2 px-8 py-12 shadow rounded-md w-[25rem]">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="w-full mb-3">
                            <button className="flex items-center justify-center py-2 bg-sky-500 w-full text-white hover:bg-sky-600 text-lg transition ease-in-out delay-150" disabled={loadingLog}>
                                {loadingLog ? <ClipLoader size={20} color={"#fff"} /> : "Login"}
                            </button>
                        </div>
