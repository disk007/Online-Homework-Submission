            ...
            <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] mb-4 ${sidebar ? 'opacity-10 pointer-events-none' : ''}` }>
                ...
                <div className="py-3 px-5 mt-2 flex flex-wrap items-center justify-center lg:justify-between md:text-base text-xs">
                    ...
                    <div className="flex items-center flex-wrap justify-center ml-2 md:mt-0 mt-2 space-x-4">
                        ...
                        <div className="">
                            <button 
                                className={`flex items-center justify-center cursor-pointer w-32 text-white md:px-5 md:py-2 px-4 py-1 rounded transition ease-in-out delay-150 ${
                                    selectedId.length === 0 || loadReturn ? 'bg-gray-300 ' : 'bg-sky-500 hover:bg-sky-600'
                                }`}
                                disabled={selectedId.length === 0 || loadReturn} // Disable เมื่อไม่มีการเลือก
