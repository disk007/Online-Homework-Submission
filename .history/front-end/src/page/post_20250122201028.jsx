                            ...
                            
                            {
                                comment[data.id] ? (
                                    <div className="w-full">
                                        ...
                                        <div><button className="text-white  py-1 transition ease-in-out delay-150 rounded px-7" onClick={addPost}><LuSendHorizonal className="w-5 md:w-6 md:h-6 h-5 text-sky-500 comment" /></button></div>
                                    </div>
                                        {/* <div>
