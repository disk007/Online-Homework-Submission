        ...
        <div className="fixed inset-0 flex justify-center items-center">
            <div className="bg-white border-2 px-8 py-12 shadow rounded-md w-[25rem]">
                ...
                <div className="my-12">
                    ...
                    <div className={`h-2 ${error && "text-center text-red-500 text-xs"} `}>{error}</div>
                </div>
                
                <div className="w-full mb-2"><button className="py-2 bg-sky-500 w-full text-white hover:bg-sky-600 text-lg transition ease-in-out delay-150" onClick={verifyAccount}>Verify Account</button></div>
            </div>
        </div>
    );
}
