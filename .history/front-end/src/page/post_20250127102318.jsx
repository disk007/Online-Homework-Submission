...
const DetailClassroom = ({isLogin}) =>{
    ...
    const [openDelComment,setOpenDelComment] = useState(false)
                    ...
                    <div className="fixed inset-0 z-[51] flex justify-center items-center bg-black/20">
                        <div className="bg-white rounded-md p-4 w-[30rem] ">
                            <div className="flex justify-end">
                                <button onClick={()=>{openDelPost(!openDelPost)}} className="w-6 h-6 hover:bg-gray-200"><RxCross2 className="w-6 h-6"/></button>
                            </div>
