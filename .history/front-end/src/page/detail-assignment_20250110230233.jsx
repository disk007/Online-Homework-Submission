                        ...
                        <div className="">
                            <div className="py-1 flex items-center justify-center">
                                <input type="checkbox" className="transform scale-150 mx-2" />
                                    { assignmentType === 'group' ? <span className="font-bold">{m.groupname}</span> : m.fname +' '+m.lname}
                            </div>
                            
                            { assignmentType === 'group' && 
                                m.group_members.split(',').map((g,key) => (
                                <div key={key} className="flex items-center justify-center my-2 border-2"><FaRegUserCircle className="w-4 h-4" /><div className="ml-1">{g}</div></div>
                            ))
                            } 
                        </div>
