        ...
        <>
            ...
            <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] mb-4 ${sidebar ? 'opacity-10 pointer-events-none' : ''}` }>
                ...
                <div key={index}>
                    ...
                    <>
                        <div className="border-2 rounded-lg mt-5 lg:mx-24 md:mx-16 mx-10 shadow py-4 w-[500px] overflow-x-auto">
                            <div className="flex">
                                <div className="md:mx-3 mx-1"><div className="rounded-full border-2 p-3"><FaUser className="md:h-8 md:w-8 h-7 w-7" /></div></div>
                                ...
                                {displayedComments.length > 0 && displayedComments.map((c,i) =>(
                                    ...
                                    <div key={i} className={`border-t-2`}>
                                        <div className="flex mt-5">
                                            <div className="md:mx-2 mx-1"><div className="rounded-full border-2 p-2"><FaUser className="w-6 h-6" /></div></div>
