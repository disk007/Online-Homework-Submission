...
const UpComming = ({isLogin}) => {
    ...
    const handleLinkClick = (workId,userId) =>{
        navigate(`/send-work/${workId}/${userId}`);
    }
        ...
        <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] mb-4 md:py-5 py-2 bg-white  ${sidebar ? 'opacity-10 pointer-events-none' : ''}`}>
            ...
            assignment.map((data,index)=>{
                ...
                <div className="w-full mb-8" key={index}>
                    ...
                    <div className="flex justifly-center items-start border-2 py-2 px-4 mx-5 rounded-md shadow cursor-pointer hover:bg-gray-100" onClick={()=>handleLinkClick(data.id,isLogin.id)}>
