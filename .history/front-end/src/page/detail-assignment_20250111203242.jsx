                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tr class="border-t-2 border-b-2 text-sm">
                            <th class="px-4 py-2 text-center w-full border-2">Name</th>
                            <th class="px-4 py-2 text-center w-full border-2">Status</th>
                            <th class="px-4 py-2 text-center w-full border-2">Files</th>
                            <th class="px-4 py-2 text-center w-full border-2">Feedback</th>
                        </tr>
                        </thead>
                        <tbody className="text-xs">
                        {detailAssignments.map((m,i) => (
                            <tr class="border-t-2 border-b-2 text-xs">
                            <td class="px-4 py-2 text-center w-full border-2">
                            ...
                            <td class="px-4 py-2 w-full border-2">
                                <div className="text-xs w-full ">
