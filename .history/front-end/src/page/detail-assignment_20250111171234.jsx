                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                            ...
                            <td class="px-4 py-2 ">
                                <div className="text-xs w-full">
                                    ...
                                    {m.work && JSON.parse(m.work).map((file) => (
                                        ...
                                        <div className="flex items-center justify-center mb-2 border-2 w-44" title={file}>
                                            <div className="px-2 py-2 flex flex-1 items-center cursor-pointer" >
                                                <div className=""><FaFileAlt className="w-4 h-4" /></div>
                                                <div className="">
                                                    <span className="pl-1">{file.length > 30 ? file.substring(0, 25) + "..." : file}</span>
                                                </div>
                        ...
                        {/* <tr class="border-t-2 border-b-2">
                            ...
                            <td class="px-4 py-2 text-center">Developer</td>
                            <td class="px-4 py-2 text-center">London</td>
                        </tr> */}
                        </tbody>
                    </table>
                </div>
                    ...
                    /> */}
                {/* <hr /> */}
                 {/* <DataTable data={data} className="display" options={{
                responsive: true,
                select: true,
                select: true,
    lengthChange: false, // ซ่อน dropdown "entries per page"
    info: false,         // ซ่อนข้อความ "Showing x to y of z entries"
    paging: false,  
            }}>
          <thead>
            <tr>
