    ...
    const listAssignments = async() => {
        try {
            if(isLogin.role === 'teacher'){
                ...
                page-post-work/:id/:id_user
                onst response = await axios.get(`page-post-work/${classroomId}/${isLogin.id}`)
                const responseData = response.data
                setAssignment(responseData)
            }
        ...
        <>
            ...
            <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] mb-4 ${sidebar ? 'opacity-10 pointer-events-none' : ''}` }>
                ...
                <div key={index}>
                    ...
                    <>
                        <div className="border-2 rounded-lg mt-5 lg:mx-24 md:mx-16 mx-10 shadow py-4 cursor-pointer hover:bg-gray-100" onClick={()=>assignmentLink(data.id_assignment)}>
