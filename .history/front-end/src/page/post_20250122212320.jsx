                            ...
                            
                            {
                                comment[data.id] ? (
                                    ...
                                    <div>
                                        ...
                                        <div className={`relative ml-3 top-2 cursor-pointer ${!isContentValid(valueComment[data.id]) ? 'text-gray-500': 'text-sky-500'}`} onClick={()=>addComment(data.id)}><LuSendHorizonal className="w-5 md:w-6 md:h-6 h-5  comment" /></div>
                                    </>
                                )
                                :(
