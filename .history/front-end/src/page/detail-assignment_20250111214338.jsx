                        ...
                        <tr class="border-t-2 border-b-2 text-sm">
                            ...
                            <th class="px-4 py-2 text-center">
                                <div className="flex items-center justify-center">
                                    <span className="mx-1">Name</span> <div className="flex-col justify-center" onClick={sortData}> <div className="border-2 flex items-end"><FaSortUp/></div> <FaSortDown  /></div>
                                </div>
                            </th>
