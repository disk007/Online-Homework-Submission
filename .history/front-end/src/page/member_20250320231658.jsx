        ...
        <>
            ...
            <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] mb-4 ${sidebar ? 'opacity-10 pointer-events-none' : ''}` }>
                ...
                <div className="my-5 flex flex-col lg:mx-24 md:mx-16 mx-10 ">
                    ...
                    <hr className="mb-2" />
                    <div className="my-2 flex items-center"><div className="border-2 p-2 rounded-full mx-3"><FaUser className="h-5 w-5" /></div><div className="text-base">{teacher.name}</div></div>
