                            ...
                            
                            {
                                comment[data.id] ? (
                                    <div className="w-full">
                                        ...
                                        <div><button className="text-white hover:border-2 p-1 rounded-full" onClick={addPost}><LuSendHorizonal className="w-5 md:w-6 md:h-6 h-5 text-sky-500 comment" /></button></div>
                                    </div>
                                        {/* <div>
