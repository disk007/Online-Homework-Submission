            ...
            <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] mb-4 ${sidebar ? 'opacity-10 pointer-events-none' : ''}` }>
                ...
                <div className="border-2 rounded-lg mt-5 lg:mx-24 md:mx-16 mx-10 shadow py-4">
                    ...
                    <div className="border-t-2 mt-2">
                        ...
                        <div className={`flex md:mx-7 mt-5 justify-center ${comment[data.id] ? "items-start" : "items-center"}`}>
                            
                            {
                                comment[data.id] ? (
                                    <>
                                        <div className="ml-2 flex w-[850px] items-end">
                                            <div className="comment w-[850px]">
                                                <ReactQuill 
                                                    theme="snow" 
                                        ...
                                        <div className={`mr-2 ml-2 top-2 ${!isContentValid(String(valueComment[data.id] || '')) ? 'text-gray-400': 'text-sky-500 cursor-pointer'}`} onClick={()=>addComment(data.id)}><LuSendHorizonal className="w-5 md:w-7 md:h-7 h-5  comment" /></div>
