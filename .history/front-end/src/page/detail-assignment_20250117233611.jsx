                    ...
                    <table className="table-fixed w-full border-collapse border-spacing-0">
                        ...
                        <tr className="border-t-2 border-b-2 text-sm">
                            ...
                            <th className="px-4 py-2 text-center">
                                <div nclassNameName="flex items-center justify-center">
                                    <span nclassNameName="mx-1">Name</span> <div className="flex cursor-pointer " onClick={()=>{sortData('name')}}>{state ==='name' && sortOrder === 'asc' ? <FaSortUp/> : <FaSortDown  />}</div>
                                </div>
                            </th>
                            <th className="px-4 py-2 text-center">
