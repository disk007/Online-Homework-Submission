            ...
            <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] mb-4 ${sidebar ? 'opacity-10 pointer-events-none' : ''}` }>
                ...
                <div className="border-2 rounded-lg mt-5 lg:mx-24 md:mx-16 mx-10 shadow py-4">
                    ...
                    <div className="border-t-2 mt-2">
                        ...
                        <div className={`flex md:mx-7 mx-2 mt-5 justify-center ${comment[data.id] ? "items-start" : "items-center"}`}>
                                        ...
                                        <div className="flex w-full items-start ">
                                            ...
                                            <div className="comment w-full">
                                                <ReactQuill 
                                                    ...
                                                    modules={modules} 
                                                    className="flex flex-col flex-col-reverse border-2"
                                                /> 
                                            </div>
                                            <div className={`ml-2 top-2 ${!isContentValid(String(valueComment[data.id] || '')) ? 'text-gray-400': 'text-sky-500 cursor-pointer'}`} onClick={()=>addComment(data.id)}><LuSendHorizonal className="w-5 md:w-10 md:h-10 h-5  comment" /></div>
                                        </div>
