                        ...
                        <tr class="border-t-2 border-b-2 text-sm">
                            ...
                            <th class="px-4 py-2 text-center">
                                <div className="flex items-center justify-center">
                                    <span className="mx-1">Name</span> <div className="flex cursor-pointer" onClick={()=>{sortData();setState('name')}}>{sortOrder === 'asc' && state === 'name' ? <FaSortUp/> : <FaSortDown  />}</div>
                                </div>
                            </th>
                            <th class="px-4 py-2 text-center">
                                <div className="flex items-center justify-center">
                                    <span className="mx-1">State</span> <div className="flex cursor-pointer" onClick={()=>{sortData();setState('state')}}>{sortOrder === 'asc' && state === 'state' ? <FaSortUp/> : <FaSortDown  />}</div>
                                </div>
                            </th>
