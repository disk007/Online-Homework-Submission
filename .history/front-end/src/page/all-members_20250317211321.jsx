    ...
    return(
        <>
            <div className="flex justify-center md:ml-32 ml-[6rem] md:py-5 py-2 bg-white items-center">
                {loading ?
                    <div className="md:ml-32 ml-[6rem] md:py-5 flex justify-center items-center fixed inset-0">
                        ...
                        <tbody className="">
                            {currentUsers.map((data,i)=>(
                                ...
                                <tr class="border-t-2 border-b-2 text-sm" key={i}>
                                    ...
                                    <td class="px-4 py-2 text-center">
                                        <span className="mr-2">{data.fname}</span>
                                        <span className="ml-2">{data.lname}</span>
                                    </td>
                                    <td class="px-4 py-2 text-center">
                                        <div>{data.email}</div>
                                    </td>
