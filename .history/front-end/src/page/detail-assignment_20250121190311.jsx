    ...
    const getScores = async () => {
        try {
            ...
            const formattedData = responseData.map(item => ({
                ascore: item.ascore || "ไม่มีคะแนน", // กำหนดค่าเริ่มต้นหาก ascore เป็นค่าว่าง
                title: item.title || "ไม่ระบุชื่อการบ้าน", // กำหนดค่าเริ่มต้นให้ title
                name: item.name || "ไม่ระบุชื่อ", // กำหนดค่าเริ่มต้นให้ name
                wscore: item.wscore !== null ? item.wscore : "N/A" // แปลงค่า null เป็น N/A
            }));
