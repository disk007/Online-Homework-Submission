    ...
    return (
        <>
            ...
            <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] mb-4 ${sidebar ? 'opacity-10 pointer-events-none' : ''}` }>
                ...
                <hr />
                <div>
                    <div className="md:flex-row flex-col justify-center md:justify-between items-center px-6 py-2 ">
                        <div className="flex justify-center">
                            <div className="mr-2">To returns</div>
                            <div className="ml-2">Returned</div>
                        </div>
                        <div className="flex justify-center">
