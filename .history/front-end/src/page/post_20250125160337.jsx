                    ...
                    <div className="border-t-2 mt-2">
                        ...
                        <div className={`flex md:mx-7 mt-5 justify-center ${comment[data.id] ? "items-end" : "items-center"}`}>
                            
                            {
                                ...
                                :(
                                    <div className="flex items-center w-full cursor-pointer hover:text-sky-500 md:text-base text-sm" onClick={() => toggleComment(data.id)}><FaRegCommentAlt className="w-5 md:w-7 md:h-7 h-5" />Comment</div>
                                )
                            }
