                ...
                <div className={`fixed inset-0 flex justify-center items-center visible bg-black/20 z-50`}>
                    <div className="bg-white rounded-md p-4">
                        ...
                        <div className="flex justify-end">
                            <div className="mr-2"><button className="border-2 py-2 px-8 w-full mt-3 text-white border-red-500 hover:border-red-600 bg-red-500 hover:bg-red-600 transition ease-in-out delay-150">Yes</button></div>
                            <div className="ml-2"><button className="border-2 py-2 px-8 w-full mt-3 text-gray-400 hover:text-gray-500 mr-2 transition ease-in-out delay-150" onClick={handleCheckboxChange}>Cancle</button></div>
