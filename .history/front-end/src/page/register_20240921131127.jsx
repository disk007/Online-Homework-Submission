...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(!formData.username.trim()){
            ...
            isValid = false
            validation.username = 'Username should contain only letters.'
        }
                ...
                <div className="bg-white border-2 px-8 py-12 shadow rounded-md w-[42rem]">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-center mb-3">
                            ...
                            <div className="w-full ml-2">
                                <div>Username</div>
                                <div className="w-full "><input type="text" name="username" id="" className="px-2 py-2 border-2 w-full" value={formData.username} onChange={handleChange} /></div>
                                <div className={`h-2 ${errors.username && "text-red-500 text-xs"} `}>{errors.username}</div>
                            </div>
