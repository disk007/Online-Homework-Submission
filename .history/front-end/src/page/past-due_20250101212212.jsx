...
const Past_due = ({isLogin}) => {
    ...
    return(
        <>
            ...
            <div className={`flex justify-center ml-[6rem] md:ml-[8rem] lg:ml-[26rem] md:py-5 py-2 hover:bg-gray-100 bg-white items-center flex-col ${sidebar ? 'opacity-10 pointer-events-none' : ''}`}>
                {assignment.length > 0 ?(
