                    ...
                    <table class="table-fixed w-full border-collapse border-spacing-0">
                        ...
                        <tr class="border-t-2 border-b-2 text-sm">
                            ...
                            {filteredAssignments[0]?.score !== '' && 
                                <th class="px-4 py-2 text-center w-20">
                                    <div className="flex items-center justify-center">
                                        <div className="mr-1"><input type="text" name="" id="" className="text-center w-8 border-2 font-normal text-sm" /></div><div> / {filteredAssignments[0]?.score}</div>
                                    </div>
                                </th>
                            } 
                        ...
                        {filteredAssignments.map((m,i) => (
                            ...
                            {filteredAssignments[0]?.score !== '' &&
                                <td className="px-4 py-2 text-center w-20 border-2">
                                    <div className="mr-1"><input type="text" name="" id="" className="text-center w-8 border-2 font-normal text-sm" /></div>
                                </td>
                            }
                            </tr>
                        ))}
