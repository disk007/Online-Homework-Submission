                ...
                <div className="overflow-x-auto">
                    <table className="table-fixed w-full border-collapse border-spacing-0">
                        ...
                        <tr className="border-t-2 border-b-2 text-sm">
                            ...
                            <th className="px-4 py-2 text-center border-2">
                                <div NameName="flex items-center justify-center">
                                    <span NameName="mx-1">Name</span> <div className="flex cursor-pointer " onClick={()=>{sortData('name')}}>{state ==='name' && sortOrder === 'asc' ? <FaSortUp/> : <FaSortDown  />}</div>
                                </div>
                            </th>
