        ...
        <>
            ...
            {loading ? (
                ...
                {assignment.length !== 0 ? (
                    ...
                    const showHeader = shouldShowYearMonth(data.due_time); // เช็คว่าจะแสดงหัวข้อเดือนและปีหรือไม่
                    return (
                        ...
                        <div
                            className="flex justify-center items-start border-2 py-2 px-4 mx-5 rounded-md shadow cursor-pointer hover:bg-gray-100"
                        ...
                        >
                            ...
                            <div className="text-gray-500 text-sm">
                                Submitted {formattedTime(data.sent_date)}
                            </div>
                    ...
                    <div className="mt-1 text-xs md:text-base">
                        No completed assignments right now.
                    </div>
                    </div>
                )}
                </>
