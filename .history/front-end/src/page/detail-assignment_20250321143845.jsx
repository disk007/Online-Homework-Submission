    ...
    return (
        <>
            ...
            <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] mb-4 ${sidebar ? 'opacity-10 pointer-events-none' : ''}` }>
                ...
                <div className="py-3 px-5 mt-2 flex flex-wrap items-center justify-between md:text-base text-xs">
                    ...
                    <div className="flex items-center flex-wrap justify-center md:mt-0 mt-2 w-full">
                ...
                <div className="md:text-2xl text-base  pt-2 px-6 mt-3">{detailAssignments[0]?.title}</div>
                <div className="text-gray-500 flex flex-wrap justify-center px-6 mb-5 md:text-base text-sm">
