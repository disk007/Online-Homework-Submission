                ...
                <div className="border-2 rounded-lg mt-5 lg:mx-24 md:mx-16 mx-10 shadow py-4">
                    ...
                    <div className="border-t-2 mt-2">
                        ...
                        {displayedComments.length > 0 && displayedComments.map((c,i) =>(
                            ...
                            <div key={i} className={` ${i !== displayedComments.length-1 ? 'border-y-2':''}`}>
                        ...
                        <div className={`border-t-2 flex md:mx-7 mx-2 mt-5 justify-center ${comment[data.id] ? "items-end" : "items-center"}`}>
