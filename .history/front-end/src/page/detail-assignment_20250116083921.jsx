...
import ModelEditAssignmen from "../components/model-edit-dassignments";
...
const Detali_assignment = ({isLogin}) => {
    ...
    return (
        <>
            ...
            <ModelEditAssignmen isLogin={isLogin} open={open} OnClose={()=>setOpen(false)} />
            { selectFile && 
                (
                    <ModelFile
                        open={openEdit}
            ...
            <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] mb-4 ${sidebar ? 'opacity-10 pointer-events-none' : ''}` }>
                ...
                <div className="py-3 px-5 mt-2 flex flex-wrap items-center justify-center">
                    <div className="flex items-center md:grow">
                        ...
                        <div className=" mx-5 hover:text-sky-600 text-gray-500 cursor-pointer transition ease-in-out delay-150" onClick={()=>setOpenEdit(!openEdit)}>Edit assignment </div>
                    </div>
