                ...
                <div key={index}>
                    ...
                    <>
                        <div className="border-2 rounded-lg mt-5 lg:mx-24 md:mx-16 mx-10 shadow py-4 ">
                            <div className="flex">
                                <div className="md:mx-3 mx-1"><div className="rounded-full border-2 p-3"><FaUser className="md:h-8 md:w-8 h-5 w-5" /></div></div>
                                ...
                                {displayedComments.length > 0 && displayedComments.map((c,i) =>(
                                    ...
                                    <div key={i} className={`border-t-2`}>
                                        <div className="flex mt-5">
                                            <div className="md:mx-2 mx-1"><div className="rounded-full border-2 p-2"><FaUser className="w-5 h-5 md:w-6 md:h-6" /></div></div>
