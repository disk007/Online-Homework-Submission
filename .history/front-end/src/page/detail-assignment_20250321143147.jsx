        ...
        <>
            ...
            <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] mb-4 ${sidebar ? 'opacity-10 pointer-events-none' : ''}` }>
                ...
                <div className="py-3 px-5 mt-2 flex flex-wrap items-center justify-between md:text-base text-xs">
                    ...
                    <div className="flex items-center flex-wrap justify-center md:mt-0 mt-1">
                        ...
                        <div className="ml-5 ">
                        <button 
                            className={`cursor-pointer text-white md:px-5 md:py-2 py-4 py-1 rounded transition ease-in-out delay-150 ${
