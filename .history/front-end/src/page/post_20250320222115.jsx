                    ...
                    <>
                        <div className="border-2 rounded-lg mt-5 lg:mx-24 md:mx-16 mx-10 shadow py-4">
                            <div className="flex">
                                ...
                                <div className="mx-2 grow text-sm md:text-base">
                                    <div >{data.name}<span className="text-red-500 text-sm md:text-xs text-gray-500">{` (${data.role})`}</span></div>
                                    <div className="text-sm md:text-xs text-gray-500">{data.update_create ? formattedDate(data.update_create) : formattedDate(data.create_at)}</div>
                                </div>
