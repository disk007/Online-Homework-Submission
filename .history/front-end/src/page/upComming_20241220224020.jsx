...
const UpComming = ({isLogin}) => {
    ...
    return(
        ...
        <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] mb-4 md:py-5 py-2 bg-white items-center flex-col ${sidebar ? 'opacity-10 pointer-events-none' : ''}`}>
            {assignment.map((data,i)=>(
                <div key={i} className="w-full border-2 rounded-lg mt-5 lg:mx-24 md:mx-16 mx-10 shadow py-4 cursor-pointer hover:bg-gray-100 text-sm" >
