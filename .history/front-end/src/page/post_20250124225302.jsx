                                ...
                                comment[data.id] ? (
                                    ...
                                    <div>
                                        ...
                                        <div className="flex w-full items-end ">
                                            ...
                                            <div className="comment w-full md:w-[450px]">
                                                <ReactQuill 
                                                    theme="snow" 
                                            ...
                                            <div className={`ml-2 top-2 ${!isContentValid(String(valueComment[data.id] || '')) ? 'text-gray-400': 'text-sky-500 cursor-pointer'}`} onClick={()=>addComment(data.id)}><LuSendHorizonal className="w-5 md:w-6 md:h-6 h-5  comment" /></div>
                                        </div>
