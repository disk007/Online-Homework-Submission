  ...
  <table class="table-fixed w-full border-collapse border-spacing-0">
    ...
    <tbody class="text-xs">
      {detailAssignments.map((m, i) => (
        <tr key={i} class="border-t-2 border-b-2 text-xs">
            ...
            <div className="flex items-center justify-center">
              <div className="">
                <div className="py-1 flex items-center justify-center">
                  <input type="checkbox" className="transform scale-150 mx-2" />
                  {assignmentType === 'group' ? (
                    <span className="font-bold">{m.group_name}</span>
                  ) : (
          ...
          <td class="px-4 py-2">
            <div className="text-xs w-full">
              {m.work === null && (
                <div className="text-sky-600 text-center">None</div>
              )}
              {m.work &&
                JSON.parse(m.work).map((file) => (
                  <div
                    className="flex items-center justify-center mb-2 border-2"
                    title={file}
                  >
                    <div className="px-2 py-2 flex flex-1 cursor-pointer">
                      <div className="">
