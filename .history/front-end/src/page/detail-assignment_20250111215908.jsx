    ...
    const sortData = (state) => {
        const sortedData = [...detailAssignments].sort((a, b) => {
            if(state === 'name'){
                ...
                if (sortOrder === 'asc') {
                    return a.group_name.localeCompare('Turned in');
                } else {
                    return b.group_name.localeCompare('Turned out');
                }
            }
                        ...
                        <tr class="border-t-2 border-b-2 text-sm">
                            ...
                            <th class="px-4 py-2 text-center">
                                <div className="flex items-center justify-center">
                                    <span className="mx-1">Name</span> <div className="flex cursor-pointer" onClick={()=>{sortData('name')}}>{sortOrder === 'asc' ? <FaSortUp/> : <FaSortDown  />}</div>
                                </div>
                            </th>
                            <th class="px-4 py-2 text-center">Status
                                <div className="flex items-center justify-center">
                                    <span className="mx-1">State</span> <div className="flex cursor-pointer" onClick={()=>{sortData('state')}}>{sortOrder === 'asc' ? <FaSortUp/> : <FaSortDown  />}</div>
                                </div>
                            </th>
