...
const Detali_assignment = ({isLogin}) => {
    ...
    const handleInputChange = (id, value) => {
        setScores((prev) => ({
            ...prev,
            [id]: value, // อัปเดตค่าของช่อง input ตาม id
        }));
        setScore('')
    };
    ...
    const handleLinkRetruned = () =>{
        navigate(`/detail-classroom/verifed-assignment/${classroomId}/${assignmentId}`);
    }
    useEffect(()=>{
                ...
                <div>
                    <div className="flex md:flex-row flex-col justify-center md:justify-between items-center px-6 py-2 ">
                        <div className="flex justify-center md:mb-0 mb-2">
                            ...
                            <div className={`inline-block mr-3 cursor-pointer hover:font-bold ${sideClass.includes('verified-assignment')?'font-bold' :''}`} onClick={handleLinkToretrun}>
