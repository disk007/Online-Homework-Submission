                                ...
                                comment[data.id] ? (
                                    ...
                                    <div>
                                        ...
                                        <div className="flex w-full items-start border-2">
                                            ...
                                            <div className={`ml-2 top-2 flex justify-end border-2 h-full ${!isContentValid(String(valueComment[data.id] || '')) ? 'text-gray-400': 'text-sky-500 cursor-pointer'}`} onClick={()=>addComment(data.id)}><LuSendHorizonal className="w-5 md:w-7 md:h-7 h-5  comment" /></div>
                                        </div>
