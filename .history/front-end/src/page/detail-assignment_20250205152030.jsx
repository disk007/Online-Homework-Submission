...
const Detali_assignment = ({isLogin}) => {
    ...
    useEffect(() => {
        const content = document.getElementById("content"); // เลือก element ที่ต้องการ
    ...
    return (
        <>
            ...
            <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] mb-4 d ${sidebar ? 'opacity-10 pointer-events-none' : ''}` }>
