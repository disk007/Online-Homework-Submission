    ...
    return(
        ...
        <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] mb-4 ${sidebar ? 'opacity-10 pointer-events-none' : ''}` }>
            ...
            {assignment.map((data,i)=>(
                <div key={i} className="flex border-2 rounded mt-5 lg:mx-18 md:mx-10 mx-8 shadow py-2 items-center cursor-pointer hover:bg-gray-100 " onClick={()=>handleLinkClick(classroomId,data.id_assignment)}>
