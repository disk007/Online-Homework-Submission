...
>
                                    ...
                                    <div className="flex md:flex-row flex-col items-center"><FaCheck className="mr-1" /> <span>Turned in</span></div>
                                    }
                                    {m.is_submitted == true  && new Date(m.sent_date) > new Date(m.due_time) &&
                                    <div className="flex md:flex-row flex-col items-center"><FaCheck className="mr-1" /> <span>Turned in late</span></div>
                                    }
