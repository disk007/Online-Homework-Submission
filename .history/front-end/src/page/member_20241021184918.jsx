                ...
                <div className={`fixed inset-0 flex justify-center items-center visible bg-black/20 z-50`}>
                    <div className="bg-white rounded-md p-4">
                        ...
                        <div className="flex justify-end mt-3">
                            <button onClick={handleDelete} className="w-12 h-6 bg-red-600 text-white px-4 py-1 rounded-md">Yes</button>
                            <button onClick={()=>setOpen(!open)} className="w-12 h-6 bg-gray-200 text-white px-4 py-1 rounded-md">Cancel</button>
                        </div>
                    </div>
                </div>
            }
