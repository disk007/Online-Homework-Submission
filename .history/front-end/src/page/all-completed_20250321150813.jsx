                        ...
                        <div className="w-full mb-5" key={index}>
                            ...
                            <div className="flex justify-center items-start border-2 py-2 px-4 mx-5 rounded-md shadow cursor-pointer hover:bg-gray-100" onClick={()=>handleLinkClick(data.id)}>
                                ...
                                <div className="flex flex-col grow">
                                    <div>{data.title}</div>
                                    <div className="text-gray-500 md:text-sm text-xs flex flex-wrap">Submitted {formattedTime(data.sent_date)}</div>
                                    <div className="text-gray-500 md:text-sm text-xs flex flex-wrap">{data.name}</div>
                                </div>
