                            ...
                            
                            {
                                comment[data.id] ? (
                                    ...
                                    <div>
                                        ...
                                        <div className={`relative ml-3 top-2 ${!isContentValid(String(valueComment[data.id])) || valueComment[data.id] === null ? 'text-gray-400': 'text-sky-500 cursor-pointer'}`} onClick={()=>addComment(data.id)}><LuSendHorizonal className="w-5 md:w-6 md:h-6 h-5  comment" /></div>
                                    </>
                                )
                                :(
