...
const DetailClassroom = ({isLogin}) =>{
    ...
    const toggleComment = (id) => {
        setComment((prevComments) => ({
          ...prevComments,
          [id]: { ...prevComments[id], visible: !prevComments[id]?.visible }, // toggle visibility
        }));
      };
    
      // ฟังก์ชันในการจัดการค่าของแต่ละ comment
      const handleCommentChange = (id, value) => {
        setComment((prevComments) => ({
          ...prevComments,
          [id]: { ...prevComments[id], value: value }, // เก็บค่าใหม่ของ comment
        }));
      };
