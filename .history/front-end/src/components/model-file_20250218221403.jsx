        ...
        >
          <div className="flex-grow flex justify-center my-1">
            <div className="p-2 border-2 bg-white">
              {type === "application/vnd.openxmlformats-officedocument.wordprocessingml.document" && isRendering  ? (
                ...
                <object
                  className="md:w-[700px] w-[400px] overflow-x-auto  h-screen"
                  data={fileUrl}
                  type="application/pdf"
                />
              ) : type === "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" ? (
                <div className="w-[500px] md:w-[700px] overflow-x-auto">
                  <table className="m-3 border-2">
                    <thead >
                      <tr className="">
                ...
                <div className="p-4 bg-gray-100 text-black md:w-[700px]  overflow-auto border">
