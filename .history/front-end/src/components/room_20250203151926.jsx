                        ...
                        <div className="border-2 w-80 h-60 rounded-md shadow-md m-5 hover:bg-gray-100 transition ease-in-out delay-150 relative cursor-pointer" onClick={() => handleLinkClick(d.id)} key={d.id}>
                                <div className="px-4 pt-5 pb-2 h-full flex flex-col relative">
                                    ...
                                    <div className="absolute bottom-1 right-2">
                                        ...
                                        {
                                             data.role === "teacher" && (
                                                <div onClick={()=>toggleEditDel(d.id)} className=""><BsThreeDots className="cursor-pointer w-6 h-6 hover:text-sky-500 transition ease-in-out delay-150 toggle-dots"/></div> 
                                            )
                                        }
                                    </div>
                                </div>
                                {
                                    editDel[d.id] && (
                                        <div className="text-sm block fixed z-[27] border-2 min-w-12 absolute right-2 -bottom-9 bg-white dots">
                                            <div className="border-b-2 px-2 cursor-pointer hover:bg-gray-100">Edit</div>
