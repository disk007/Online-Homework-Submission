                ...
                <div className="bg-white rounded-md p-4 w-[30rem]">
                    ...
                    <div className={`mt-2 mb-1 flex justify-end`}>
                        <div className="hover:text-sky-500">
                            <button  className={`flex items-center border-2 py-2 px-8 w-full bg-sky-500 text-white border-sky-500 cursor-pointer mt-3 hover:border-sky-600 hover:bg-sky-600 transition ease-in-out delay-150`} ><MdAddCall className="w-6 h-6" /><span>Add</span></button>
                        </div>
                    </div>
                </div>
            </div>
