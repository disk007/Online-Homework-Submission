...
const Room = ({data}) =>{
    ...
    //     fetchJoinedRoom()
    // },[])
    console.log('dataRoom ',data.role)
    return(
        <>  
                                ...
                                <div className="px-4 pt-5 pb-2 h-full flex flex-col relative">
                                    ...
                                    <div className="mt-5 ">
                                        <div className="flex justify-center">
                                            <div className="text-center line-clamp-2">{data.role}</div>
                                        </div>
                                    </div>
                                    {
                                        data.role === "student" && (
                                    <div className="absolute bottom-1 right-2">
                                            <div className="">xxxxxxxxxx<MdOutlineLogout className="cursor-pointer w-6 h-6 hover:text-sky-500 transition ease-in-out delay-150 toggle-dots"/></div>
