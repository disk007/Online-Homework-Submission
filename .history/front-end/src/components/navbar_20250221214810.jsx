                ...
                <div className={`fixed inset-0 flex justify-center items-center visible bg-black/20 z-50`}>
                    <div className="bg-white rounded-md p-4 w-[550px]">
                        ...
                        <div className="mt-3 flex justify-end">
                            <div className="cursor-pointer hover:text-sky-500" onClick={()=>setDisableProfile(!disableProfile)}>
                        ...
                        <div className={`mt-2 mb-3 flex justify-end h-10 `}>
                            <div className="hover:text-sky-500">
                                <button onClick={updateProfile} className={`border-2 py-2 px-8 w-full ${disableProfile ? 'pointer-events-none bg-gray-100 text-gray-300':'bg-sky-500 text-white border-sky-500 cursor-pointer'} mt-3   hover:border-sky-600  hover:bg-sky-600 transition ease-in-out delay-150`} >Update</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {openPassword && (
                <div className={`fixed inset-0 flex justify-center items-center visible bg-black/20 z-50`}>
                    <div className="bg-white rounded-md p-4 w-[500px]">
                        ...
                        <div className="mt-5">
                            <div className="my-1">Old password</div>
                            <input className="w-full border-2 py-2 px-2" type="password" name="old" id="old" />
                            <div className="mt-2 my-1">New password</div>
                            <input className="w-full border-2 py-2 px-2" type="password" name="new" id="new" />
                            <div className="mt-2 my-1">Confirm password</div>
                            <input className="w-full border-2 py-2 px-2" type="password" name="con" id="con" />
                        </div>
                        <div className={`mt-2 mb-3 flex justify-end h-10 `}>
                            <div className="hover:text-sky-500">
                                <button className={`py-2 px-8 w-full  mt-3  hover:border-sky-600 bg-sky-500 text-white hover:bg-sky-600 transition ease-in-out delay-150`} >Update</button>
                            </div>
                        </div>
                    </div>
                </div>
