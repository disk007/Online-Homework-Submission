                ...
                <div className="flex flex-wrap overflow-y-auto pb-5">
                    {
                        ...
                        <div className="border-2 w-80 h-60 rounded-md shadow-md hover:bg-gray-100 transition ease-in-out delay-150 relative cursor-pointer" onClick={() => handleLinkClick(d.id)} key={d.id}>
