...
const ModelEditAssignment = ({assignmentId,isLogin,open,OnClose}) => {
    ...
    const handleEditAssignment = async (e) => {
        ...
        if (dataAssignment.score !== '' && !/^[0-9]+$/.test(formData.score)) {
            isValid = false;
    ...
    console.log("due_time: "+new Date(dataAssignment.due_time)+'due_date '+formData.dueDate, "due_time: "+formData.dueTime);
    return(
        <>
            <ToastContainer />
            { selectFile && 
                ...
                <div className="bg-white rounded-md w-[600px] max-h-screen overflow-y-auto ">
                    ...
                    <div className="px-4 py-2">
                        ...
                        <div className="flex justify-end">
                            ...
                            <div className="ml-2"><div className="border-2 py-2 px-8 w-full mt-3 text-white border-sky-500 hover:border-sky-600 bg-sky-500 hover:bg-sky-600 transition ease-in-out delay-150" onClick={handleEditAssignment}>Create</div></div>
