    ...
    return(
        <>
            {/* <div className="flex justify-between mt-3">
                <div className="text-lg font-medium"> Display Group </div>
                <button onClick={resetGroup} className="w-6 h-6 hover:bg-gray-200"><RxCross2 className="w-6 h-6"/></button>
            </div> */}
