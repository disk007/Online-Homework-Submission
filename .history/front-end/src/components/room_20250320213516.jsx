                ...
                <div className="flex flex-wrap overflow-y-auto pb-5">
                    {
                        ...
                        <div className="border-2 md:w-80 w-64 h- m:h-60 rounded-md shadow-md m-5 hover:bg-gray-100 transition ease-in-out delay-150 relative cursor-pointer" onClick={() => handleLinkClick(d.id)} key={d.id}>
