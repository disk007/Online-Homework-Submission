...
const Navbar = ({isLogin}) =>{
    ...
    const handleCancle = () => {
        ...
        setErrors({})
        setProfileData({fname:isLogin?.lname,lname:isLogin?.fname})
    }
                    ...
                    <div className="bg-white rounded-md p-4 w-[550px]">
                        ...
                        <div className={`flex mt-2 ${disableProfile ? 'text-gray-300' : 'text-black'}`}>
                            <div className="w-full mr-2">
                                <input className="w-full border-2 py-2 px-2" type="text" name="fname" id="" value={profileData.fname} onChange={(e)=>setProfileData({...profileData,fname:e.target.value})} disabled={disableProfile} />
                                <div className={`h-2 ${errors.fname && "text-red-500 text-xs"} `}>{errors.fname}</div>
                            </div>
                            <div className="w-full ml-2">
                                <input className="w-full border-2 py-2 px-2" type="text" name="lname" id="" value={profileData.lname} onChange={(e)=>setProfileData({...profileData,lname:e.target.value})} disabled={disableProfile} />
