                    ...
                    <div className="bg-white rounded-md p-4 w-[600px]">
                        ...
                        <div className="flex mt-2">
                            <div className="w-full mr-2">
                                <input className="w-full border-2 py-2 px-2" type="text" name="fname" id="" value={profileData.fname} onChange={(e)=>setProfileData({...profileData,fname:e.target.value})} />
                            </div>
                        ...
                        <div className="mt-3 flex justify-end h-10 mb-2">
                            <div className="cursor-pointer hover:text-sky-500">
