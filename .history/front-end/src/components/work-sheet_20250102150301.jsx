    ...
    return(
        <>  
            ...
            <div className={`ml-[6rem] md:ml-[8rem] lg:ml-[26rem] ${sidebar ? 'opacity-10 pointer-events-none ': ''} `}>
                ...
                <div className="flex items-center  hover:text-sky-600 text-gray-500 cursor-pointer transition ease-in-out delay-150"><IoChevronBackOutline className="h-7 w-7"/>Back</div>
