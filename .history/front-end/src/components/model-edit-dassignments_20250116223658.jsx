                    ...
                    <div className="px-4 py-2">
                        ...
                        <div className="flex items-end">
                            ...
                            <div className={`w-full ml-2 relative `}>
                                <div className="border-2 py-2 px-2 hover:bg-gray-200 cursor-pointer flex items-center justify-between toggle-type-work" >{data.assignment_type}<FaUserPlus/></div>
