                    ...
                    <div className="px-4 py-2">
                        ...
                        <div >
                            ...
                            <ReactQuill 
                                        theme="snow" 
                                        value={value} 
                                        onChange={formData.instructions} 
                                        modules={modules} 
                                        ...
                                        <>
                                            {ownStudy &&(
                                                <ul className="absolute left-0 w-full border-2 bg-white z-10 group-study overflow-y-auto h-32">
                                                    ...
                                                    <li  className="px-2 py-2 cursor-pointer flex items-center pointer-events-none" onClick={()=>handleGroupStudy(ownStudy.id)} >
                                                        <input 
                                                            type="checkbox" 
                        ...
                        <div className="flex items-end">
                            ...
                            <div className={`w-full ml-2 relative `}>
                                ...
                                {openWork  &&(
                                    <>
                                    <ul className="absolute left-0 w-full border-2 bg-white z-10 type-work">
                                        { selectStudy && (
                                            <li
