...
const ModelEditAssignmen = ({isLogin,open,OnClose}) => {
    ...
    console.log('formData.name:', dataAssignment.length);
    return(
        <>
            <ToastContainer />
            { selectFile && 
            ...
            <div className={`fixed inset-0 flex justify-center items-center  ${open ? "visible bg-black/20 z-40" : "invisible"}`}>
                <div className="bg-white rounded-md w-[600px] max-h-screen overflow-y-auto ">
                    {dataAssignment.map((data,i)=>(

                    <form onSubmit={handleAssignment} key={i}>
                    ...
                    <div className="px-4 py-2">
                        <div className="mb-3">
                            <div>Title :</div>
                            <input type="text" className="border-2 w-full py-2 px-2 mt-1" name="title" value={data.title} onChange={handleChange}  />
                        ...
                        <div className="flex items-end">
                            <div className="w-full mr-1">
                                <div>Points : {formData.assignment_type}</div>
                                <input
                                type="text"
