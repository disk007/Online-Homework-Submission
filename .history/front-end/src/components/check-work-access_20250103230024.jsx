...
const checkWorkAccess = (WrappedComponent) => {

    return ({ ...props }) => {
        const { workId,classroomId } = useParams()
        ...
        const checkAuthorization = async () => {
            try {
              const response = await axios.post('/check-work-access', {
                userId: isLogin.id,
                workId: workId,
...
export default checkWorkAccess