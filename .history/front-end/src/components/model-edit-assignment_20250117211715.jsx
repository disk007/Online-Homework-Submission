...
const ModelEditAssignment = ({assignmentId,isLogin,open,OnClose}) => {
    ...
    console.log("dataAssignment.due_time ="+dataAssignment.due_time)
    return(
        <>
            <ToastContainer />
            { selectFile && 
                    ...
                    <div className="px-4 py-2">
                        ...
                        <div className="mb-3 mt-3 flex">
                            <div className="w-full mr-1">
                                <div>Due date:</div>
                                <Flatpickr
                                    value={dataAssignment.due_time ? new Date(dataAssignment.due_time) : new Date()}
                                    name="DueDate"
                                    className="border-2 w-full py-2 px-2 mt-1"
                        ...
                        <div className="mb-3">
                            ...
                            <div className={`flex ${isChecked ?'text-black': 'text-gray-400'}`}>
                                <div className="w-full mr-1">
                                    <div>Close date:</div>
                                    <Flatpickr
                                        value={dataAssignment.colses_time}
                                        className={`border-2 w-full py-2 px-2 mt-1 `}
                                        onChange={(selectedDates) => {
