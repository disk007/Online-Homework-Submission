...
const Navbar = ({isLogin}) =>{
    ...
    return(
        <>
            ...
            {openProfile && (
                <div className={`fixed inset-0 flex justify-center items-center visible bg-black/20 z-50`}>
                    <div className="bg-white rounded-md p-4 w-[550px]">
                        ...
                        <div className={`flex mt-2 flex-wrap flex-nowrap ${disableProfile ? 'text-gray-300' : 'text-black'}`}>
            ...
            {openTeacher &&(
                <Model_number_teacher open={openTeacher} OnClose={()=>setOpenTeacher(false)} /> 
            )}
