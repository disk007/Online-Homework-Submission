                    ...
                    <ul className="mx-3 mt-4">
                        ...
                        <div className="inline-block">
                                {data && data.role === 'teacher' &&(
                                    <>
                                        <li ><Link to={`/detail-classroom/list-assignments/${classroomId}`} className={`flex items-center mt-2 hover:text-sky-500 text-lg transition ease-in-out delay-150 ${sideClass.includes('list') ? "font-bold" : ''}`}><GoChecklist /><span className={`ml-2`}>Assignment</span></Link></li>
                                        <div className={`${sideClass.includes('list') ? "bg-sky-500  h-1 rounded" : ""}`}></div>
                                    </>
                                    
                                )}
                                {data && data.role === 'student' &&(
                                    <>
                                        <li ><Link to={`/detail-classroom/up-comming/${classroomId}`} className={`flex items-center mt-2 hover:text-sky-500 text-lg transition ease-in-out delay-150 ${sideClass.includes('up') || sideClass.includes('past') || sideClass.includes('compl') || sideClass.includes('send') || sideClass.includes('detail-assignment') ? "font-bold" : ''}`}><GoChecklist /><span className="ml-2">Assignment</span></Link></li>
                                        <div className={`${sideClass.includes('up') || sideClass.includes('past') || sideClass.includes('compl') || sideClass.includes('send') || sideClass.includes('detail-assignment') ? "bg-sky-500 w-[8.7rem] h-1 rounded" : ""}`}></div>
                                    </>
                                )}
                        </div><br />
                        <div  className="inline-block">
