                    ...
                    <div className="overflow-x-auto max-h-36 overflow-y-auto mb-2">
                        <table class="table-auto w-full border-collapse border-spacing-0">
                            ...
                            <tbody className="h-8 overflow-y-auto">
                                {dataNumber.filter(s => s.number.toLowerCase().includes(search.toLowerCase())).map((data,i)=>(
                                    <tr class="border-t-2 border-b-2 text-sm" key={i}>
                                        ...
                                        <td class={`px-4 py-2 flex justify-center ${data.status === 'Unavailable'? 'text-gray-200 pointer-events-none':'cursor-pointer'}`}  onClick={()=>del_num_teacher(data.)}>
                                            <div className=""><ImBin /></div>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
