                ...
                <div className="flex flex-wrap overflow-y-auto pb-5">
                    {
                        ...
                        <div className="border-2 w-80 h-60 rounded-md shadow-md m-5 hover:bg-gray-100 transition ease-in-out delay-150 relative cursor-pointer" onClick={() => handleLinkClick(d.id)} key={d.id}>
                                ...
                                {
                                    editDel[d.id] && (
                                        <div className="text-xs block fixed z-[27] border-2 min-w-12 absolute right-2 -bottom-8 bg-white dots">
                                            <div className="border-b-2 px-1 cursor-pointer hover:bg-gray-100">Edit</div>
                                            <div className="px-1 cursor-pointer hover:bg-gray-100" >Delete</div>
                                        </div>
                                    )
                                }
                                {/* {open === data.id && (
