                    ...
                    <ul className="mx-3 mt-4">
                        ...
                        <div className="inline-block">
                                ...
                                {data && data.role === 'student' &&(
                                    <>
                                        <li ><Link to={`/detail-classroom/up-comming/${classroomId}`} className={`flex items-center mt-2 hover:text-sky-500 text-lg transition ease-in-out delay-150 ${sideClass.includes('up') || sideClass.includes('past') || sideClass.includes('compl') || sideClass.includes('send') || sideClass.includes('detail-classroom') ? "font-bold" : ''}`}><GoChecklist /><span className="ml-2">Assignment</span></Link></li>
                                        <div className={`${sideClass.includes('up') || sideClass.includes('past') || sideClass.includes('compl') || sideClass.includes('send') || sideClass.includes('detail-classroom') ? "bg-sky-500 w-[8.7rem] h-1 rounded" : ""}`}></div>
                                    </>
                                )}
                        </div><br />
                        <div  className="inline-block">
