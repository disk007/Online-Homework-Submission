...
const MenuGroup = ({menuGroup}) => {
    ...
    const handleRememberGroup = () => {
        ...
        setStudent([student.filter(st =>dataRememberGroup.some(group => st.id_user !== group.id_user))])
        setCurrentPage(3);
    };
    console.log("dddd "+student.filter(st =>dataRememberGroup.some(group => st.id_user !== group.id_user)))
    // // useEffect(()=> {
