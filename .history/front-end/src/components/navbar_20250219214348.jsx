                    ...
                    <div className="bg-white rounded-md p-4 w-[600px]">
                        ...
                        <div className="flex mt-5">
                            <div className="w-full mr-2">
                                <input className="w-full border-2 py-2 px-2" type="text" name="" id="" value={profileData.fname} />
                            </div>
                            <div className="w-full ml-2">
                                <input className="w-full border-2 py-2 px-2" type="text" name="" id="" value={profileData.lname} />
                            </div>
                        </div>
                    </div>
                </div>
