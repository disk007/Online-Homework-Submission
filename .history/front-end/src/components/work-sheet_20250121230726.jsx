...
const Work_sheet = ({isLogin,workId,sidebar,setSidebar}) =>{
    ...
    const submitComment = async(e) => {
        ...
        if(!isContentValid(value)) {
            ...
            const response = await axios.post('/add-comment-work',data,{
                ...
                {myWork.filter(f => f.id == workId).map((data,i) => (
                    ...
                    <div className={` rounded-md p-2 px-5 shadow-md mt-12 lg:text-base text-sm border-2`}>
                        ...
                        {dataComment.length > 0 && dataComment.map((data,index)=>(
                             <div className="my-4 flex justify-center flex-col items-center border-x-2">
                                <div className="flex">
                                    <div className="mr-1">
                                    ...
                                    <div className="ml-1 text-sm text-gray-800">
                                        ...
                                        <div className="mb-2" dangerouslySetInnerHTML={{ __html: data.message }}></div>
                                    </div>
                                </div>
