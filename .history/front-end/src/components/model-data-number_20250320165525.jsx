                ...
                <div className="bg-white rounded-md p-4 w-[30rem]">
                    ...
                    <div className={`mt-1 mb-1 flex justify-between items-center`}>
                        <div className="hover:text-sky-500">
                            <button  className={`flex items-center border-2 pt-1 px-7 w-full bg-sky-500 text-white border-sky-500 cursor-pointer mt-3 hover:border-sky-600 hover:bg-sky-600 transition ease-in-out delay-150`} ><MdAddCall className="w-6 h-6" /><span className="ml-1">Add</span></button>
                        </div>
                        <div>
                            <input
                                type="text"
