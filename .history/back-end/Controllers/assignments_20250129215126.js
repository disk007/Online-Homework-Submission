            ...
            insertedIds = await Promise.all(
                idRoomFilter.map(async (d, i) => {
                    const result = await db.query(
                        'INSERT INTO assignment (title, instructions, score, reference_files, due_time, colses_time, id_classroom,assignment_type,create_) VALUES ($1, $2, $3, $4, $5, $6, $7,$8) RETURNING id',
