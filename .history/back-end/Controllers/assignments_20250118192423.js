...
exports.update_assignment = async(req,res) => {
    try {
        ...
        if(colses_time !== 'null'){
            ...
            let close_DateTime = `${closeDateTime.getFullYear()}-${(closeDateTime.getMonth() + 1).toString().padStart(2, '0')}-${closeDateTime.getDate().toString().padStart(2, '0')} ${closeDateTime.getHours().toString().padStart(2, '0')}:${closeDateTime.getMinutes().toString().padStart(2, '0')}:00`;
