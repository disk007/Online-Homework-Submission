...
exports.my_work = async(req,res) => {
    try {
        const {user_id} = req.params
        const querySql = `SELECT a.id AS id_assignment,a.score AS aScore,w.score AS wScore,a.due_time,a.colses_time,w.work,w.verify,w.feedback,w.id,w.is_submitted,w.sent_date,w.id_group FROM assignment AS a
