...
exports.send_work = async(req, res) => {
    try {
        ...
        const queryCheckType = `SELECT a.assignment_type,w.id_group,a.id_classroom,a.colses_time AT TIME ZONE 'UTC' AT TIME ZONE 'Asia/Bangkok' AS colses_time FROM assignment AS a
            INNER JOIN work AS w ON w.id_assignment = a.id
            WHERE w.id = $1
        ...
        console.log("date1 ",sendDateInBangkok," date2 ",date_closes)
